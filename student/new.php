...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO records (user_id, title, description, latitude, longitude, record_type, record_date) VALUES (%s, %s, %s, %s, %s, %s, %s)",
